...
const ServiceCard = ({item, index}) => {
  ...
  return (
    <div className='py-[30px] px-3 lg:px-5'>
        ...
        <Link to='/doctors' className='w-[44px] rounded-full border border-solid border-[#181A1E] flex items-center justify-center gorup hover:bg-primarycolor hover:border-none'>
